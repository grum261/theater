...
const (
	costumeInsert = `INSERT INTO costumes (
		name, description, is_decor, is_archived, size, 
	...
	costumeUpdate = `
	UPDATE costumes SET name = $2, desciption = $3, is_decor = $5, is_archived = $6, size = $7, 
	image_front = $8, image_back = $9, image_sideway = $10, image_details = $11 WHERE id = $1`
	...
	SELECT c.id, c.name, c.size, c.description, c.image_front, 
